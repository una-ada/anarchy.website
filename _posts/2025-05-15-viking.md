...
> <span class="lang_code">ANG</span> _kyning_,
> <span class="lang_code">IS</span> _konungr_ or _kongr_; but
...
(<span class="lang_code">OFS</span>) _wīka_ \> _wiking_ could be extended
...
via Heide,[^fn20] which also originates from <span class="lang_code">ON</span>
...
[^fn18]:
    ...
    $24.95 and taking between 25 to 45 _business days_. Which is, sadly, outside
    my budget of $0 for this series.
