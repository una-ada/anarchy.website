...
## I. How the fuck do you make a font?
...
## II. Just fucking get on with it.
...
Here's the thing, I have a scanner; well, access to a scanner. *However*, said scanner is down to flights of stairs and I'd have to carry my laptop down there and fiddle with the device settings and blah blah blah... So I just wrote out a few blocks and took a picture with my phone. This is professional grade. Industry standard. I've seen manga scans worse than this picture so I stand by my statement. Going to get the picture onto my laptop by using the USB cable for once, almost sent it to myself on Twitter, lmao.

Then, with a bit of adjustment in Photoshop (using Camera RAW Filter because fuck you), I have this!
...
Of course, I would like to not have to type out the namelist, but I can't fucking think so here I am. Oof.
